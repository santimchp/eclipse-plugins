...
public class ProjectToolchainsPathPropertiesPage extends FieldEditorPropertyPage {
	...
	protected void createFieldEditors() {
		...
		FieldEditor combinationLabelField = new StringVariableFieldEditor("combinationsSet", "projectMultilibsCombinations", "description", "Supported combinations: ", getFieldEditorParent());
